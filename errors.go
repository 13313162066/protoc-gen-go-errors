...
func genErrorsReason(_ *protogen.Plugin, _ *protogen.File, g *protogen.GeneratedFile, enum *protogen.Enum) bool {
	...
	msg := ""
	if defaultMsg := proto.GetExtension(enum.Desc.Options(), errors.E_DefaultMsg).(string); defaultMsg != "" {
		msg = defaultMsg
	}
	var ew errorWrapper
	for _, v := range enum.Values {
		...
		if eMsg := proto.GetExtension(v.Desc.Options(), errors.E_Message).(string); eMsg != "" {
			msg = eMsg
		}
